...
class Algo():
    ...
    def algo_avail_positions(self,board):
        positions = []
        # print(f'finding avail positions')
        for c in range(7):
            # print(f'column: {c+1}')
            # print(f'value: {board[0,c]}')
            if board[0,c] == 0:
                positions.append(c)
        return positions
    ...
    def select_best_move(self,board,algo_player,move_num=100):
        winning_move = 99
        move_dict = {}
        move_results = {}
        ...
        if move_num < 12:
            ...
            self.explore = self.explore / 2
        else:
            self.explore = 0
        # print(f'explore_threshold: {self.explore}')
        # print(f'explore_selection: {explore_selection}')
        if explore_selection <= self.explore:
            # print('Algo: Exploring..')
            if len(avail_positions) == 1:
